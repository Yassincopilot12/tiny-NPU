#!/usr/bin/env python3
"""Generate LLaMA weights.bin + golden tokens from HuggingFace MicroLlama weights.

Downloads keeeeenw/MicroLlama (300M params, LLaMA architecture with GQA),
...
# ── MicroLlama source dimensions ─────────────────────────────────────
HF_REPO       = "keeeeenw/MicroLlama"
HF_HIDDEN     = 1024
HF_N_HEADS    = 16
HF_N_KV_HEADS = 4
...
def load_hf_tensors(repo_id):
    """Download and load MicroLlama safetensors as numpy arrays."""
...
def main():
    ap = argparse.ArgumentParser(
        description="Generate LLaMA demo weights from HuggingFace MicroLlama")
    ...
    print("\nDownloading MicroLlama weights...")
    ...
    for i in range(N_LAYERS):
        ...
        # Zero QKV bias (MicroLlama has no QKV bias)

// =============================================================================
// tb_mixed_precision_cnn.cpp - Mixed Precision CNN test for Graph Mode
// Exercises Conv lowering + MaxPool2D engine + ReLU. Loads program/tdesc/
// ddr_image from files, runs graph pipeline, handles DMA transfers in C++,
// compares output against golden.
// =============================================================================
#include <cstdio>
#include <cstdlib>
#include <cstdint>
...
// Helpers
// =============================================================================
static std::string g_datadir = "build/graph_mixed_cnn";
...
int main(int argc, char** argv) {
    ...
    printf("=== Mixed Precision CNN Test ===\n");
    ...
    dut->trace(tfp, 99);
    tfp->open("mixed_precision_cnn.vcd");
